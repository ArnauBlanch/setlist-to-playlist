...
@Schema(requiredProperties = {"musicPlatformId", "name", "albumName", "albumCoverUrl", "durationSeconds", "previewUrl"})
public record SongResponse(
        @Schema(description = "Music platform song ID", example = "5G1sTBGbZT5o4PNRc75RKI")
