...
export default function ArtistSetlistCard({
	...
	return (
		<div className="group overflow-hidden rounded-2xl bg-gradient-to-r from-pink-600 via-red-500 to-amber-400 text-white shadow-xl">
			<div
				className={`h-full bg-black p-4 !pt-20 sm:p-4 ${
					available
			...
			>
				<div
					className={`flex flex-row items-center gap-1 text-xs font-normal md:text-sm ${
				...
				<div className="mt-2 flex flex-wrap gap-1">
					{available && (
						<div className="flew-row flex items-center whitespace-nowrap rounded-full bg-pink-300 px-2 py-1 text-xs text-pink-900 dark:bg-pink-800 dark:text-pink-100">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
					...
					{available && (
						<div className="flew-row flex items-center whitespace-nowrap rounded-full bg-amber-300 px-2 py-1 text-xs text-amber-900 dark:bg-amber-700 dark:text-amber-100">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
							...
							<span className="ml-1">1 h 24 min</span>
						</div>
					)}

					{!available && (
						<div className="flew-row flex items-center whitespace-nowrap rounded-full bg-red-600 px-2 py-1 text-xs">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="none"
								viewBox="0 0 24 24"
