	...
	return (
      ...
      */}
			...
			<body className="bg-white dark:bg-gray-900 flex flex-col min-h-screen">
				<AppThemeProvider>
					<nav className="sticky bg-white dark:bg-gray-900 h-12 md:h-16 px-4 sm:px-4 py-2.5 w-full z-20 top-0 left-0">
						<div className="container flex flex-wrap items-center justify-between mx-auto">
							<Link href="/" className="flex items-center">
								<svg
									...
									viewBox="0 0 60 60"
									xmlSpace="preserve"
									className="h-8 mr-3 w-8 fill-white dark:fill-gray-900 bg-gradient-to-r from-amber-400 to-rose-700"
								>
									<path
										id="path180"
					...
					<footer className="mt-auto p-4 rounded-lg md:flex md:items-center md:justify-between md:p-6">
						<div className="text-left">
							<div className="text-xs md:text-sm text-gray-500 dark:text-gray-400 flex flex-row">
								...
								>
									<svg
										className="h-5 md:h-6 fill-gray-500 dark:fill-white hover:fill-gray-800 dark:hover:fill-gray-20"
										viewBox="0 0 559 168"
									>
								...
								<a
									...
									target="_blank"
									rel="noreferrer"
									className="my-auto font-bold hover:text-gray-800"
								>
									Setlist.fm
								</a>
							</div>
							<p className="mt-2 text-xs md:text-sm text-gray-500 dark:text-gray-400">
								Made with ❤️ by{' '}
								<a
									href="https://github.com/ArnauBlanch"
